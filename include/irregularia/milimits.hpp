...
{
private:
  using traits = irregularia::multiple_int<BitWidth>::traits;
  using limits = std::numeric_limits<traits::int_type>;
...
public:
  ...
  static constexpr bool is_signed = std::is_signed_v<traits::int_type>;
  static constexpr bool is_integer = std::is_integral_v<traits::int_type>;
  ...
  {
    constexpr auto imin = std::numeric_limits<traits::int_type>::max();
    return irregularia::multiple_int<BitWidth> {imin & traits::int_mask};
  }
  ...
  {
    constexpr auto eps = std::numeric_limits<traits::int_type>::epsilon();
  ...
  static constexpr auto epsilon() noexcept
      -> irregularia::multiple_int<BitWidth>
  {
    constexpr auto re = std::numeric_limits<traits::int_type>::round_error();
  ...
  static constexpr auto infinity() noexcept
      -> irregularia::multiple_int<BitWidth>
  {
    constexpr auto inf = std::numeric_limits<traits::int_type>::infinity();
