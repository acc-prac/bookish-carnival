...
hidden if the `irregularia_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `irregularia_DEVELOPER_MODE` to the configure
...
Runs the executable target `irregularia_exe`.
