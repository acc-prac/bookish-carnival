...
hidden if the `bookish-carnival_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `bookish-carnival_DEVELOPER_MODE` to the configure
...
Runs the executable target `bookish-carnival_exe`.
