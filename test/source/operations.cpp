...
TEST(Max, TwoWay)
{
  ...
  auto l = irregularia::multiple_int<7, std::uint32_t>::encode(std::array{0x10, 0x10, 0x01, 0x01});
  auto r = irregularia::multiple_int<7, std::uint32_t>::encode(std::array{0xEF, 0xEF, 0xEF, 0xEF});
