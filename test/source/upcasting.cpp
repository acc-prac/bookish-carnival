...
TEST(Upcast, NoSignBits)
{
...

  {
    ...
    EXPECT_EQ(0b0000'00000000000'010010011'00000000000'000000001'00000000000'001111010,
              t.intv());
    EXPECT_EQ(0, t.carry());
  }
}
...
TEST(Upcast, SignBits)
{
...

  {
    ...
    EXPECT_EQ(0b0000'01111111111'110010011'01111111111'100000001'01111111111'101111010,
              t.intv());
    EXPECT_EQ(0, t.carry());
  }
}
