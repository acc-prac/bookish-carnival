...
{
  {
    ...
    EXPECT_EQ(0b00'01001'01111'00000'00000'00101'00001, t.intv())
        << "Got " << std::bitset<32>(t.intv()) << "\n";
    EXPECT_EQ(0b00'10000'10000'00000'00000'10000'00000, t.carry())
        << "Got " << std::bitset<32>(t.carry()) << "\n";
  }
}